...
//    }
    ...
    public GenericDetalleBCR(Integer iddet, Estacion estacion, GenericBeanMedioPago mediopago, String genlote, GenericBeanCliente cliente, Double venta, String comentario) {
        this.iddet = iddet;
        this.estacion = estacion;
        this.mediopago = mediopago;
        this.genlote = genlote;

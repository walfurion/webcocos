 ...
 */
public class PrTurn extends Panel implements View {
...
//        lblMessage.addStyleName(ValoTheme.LABEL_H2);
        ...
        cltInfo.setWidth(100f, Sizeable.Unit.PERCENTAGE);
        ...
        cltToolbar.setWidth(100f, Sizeable.Unit.PERCENTAGE);
...
//            cltToolbar.addComponents(utils.vlContainer(cbxConfiguracion), utils.vlContainer(lblHoraConf));
        ...
        cltButton.setWidth(100f, Sizeable.Unit.PERCENTAGE);

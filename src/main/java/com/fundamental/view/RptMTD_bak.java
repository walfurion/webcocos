 ...
 */
public class RptMTD_bak extends Panel implements View {
...
//                    totalOtrosProductos = service.getMTDVentaOtrosProductos(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, true);
//                    detalleOtrosProductos = service.getMTDVentaOtrosProductos(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, false);
//
//                    midataTurno = service.getMTDVentaTurnoByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId);
//                    midataIsla = service.getMTDVentaIslaByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId);
//                    midataMP = service.getMTDMediospagoByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId);
//                    midataMPefe = service.getMTDEfectivoByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId);
//                    midataInvFin = service.getMTDInventarioByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, "FINAL");
//                    midataInvComp = service.getMTDInventarioByFechaEstacion(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, "COMPRAS");
//                    midataCalib = service.getMTDCalibraciones(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, productosIds);
//                    midataFaltSob = service.getMTDFaltanteSobrante(dfdFechaInicial.getValue(), dfdFechaFinal.getValue(), estacionId, productosIds);
                    ...
                    if (hasPriceF) {
                        ...
                        for (String[] content : midataPriceF) {
                            if (!uFecha.isEmpty() && !uFecha.equals(content[0])) {
                                ...
                                mymap.put(uFecha.concat(estacion), datamap);
                                uFecha = content[0];
                        ...
                        for (String[] content : midataPriceA) {
                            if (!uFecha.isEmpty() && !uFecha.equals(content[0])) {
                                if (!yaAgregoNombreE) {
                                    ...
                                    mymap.get(uFecha.concat(estacion)).addAll(datamap);
                                }
                                uFecha = content[0];
                                datamap = new ArrayList();
                            } else if (uFecha.isEmpty()) {
